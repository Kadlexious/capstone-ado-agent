...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=capstone-ado-agent,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning(f"Could not load GCP default credentials, skipping OpenTelemetry exporter setup: {e}")
